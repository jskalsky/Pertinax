...
int main()
{
    ...
    UA_StatusCode retval = UA_ServerConfig_setDefaultWithSecurityPolicies(pConfig, 4840, &certificate, &privateKey, trustList, trustListSize, NULL, 0, NULL, 0);
    printf("setDefaultWithSecurityPolicies= %x\n", retval);
